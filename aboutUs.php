  ...
  <section class="adili-about-section">
    <div class="container-about">
      ...
      <p class="experience-text">
        Bellwick LLP is a leading consultancy firm based in Nairobi, providing accounting, audit, tax, and business advisory services to a wide range of businesses and individuals.      </p>
      <p class="experience-text">
...
<section class="why-clients">
  <div class="container">
    <h2 class="section-title">Why Clients Choose Bellwick</h2>
